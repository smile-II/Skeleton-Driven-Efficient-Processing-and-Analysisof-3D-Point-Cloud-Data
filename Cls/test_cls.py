...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='Cls-2-2023-09-20-14-49-51_seed_764', help='Experiment root')
...
def main():
    ...
    logger = Logger('%s/%s.txt' % (exp_dir, 'eval-' + timestr))
    ...
    with torch.no_grad():
        ...
        logger.info('Test Instance Accuracy: %f, Test Class Accuracy: %f' % (instance_acc, class_acc))
